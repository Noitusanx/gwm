...
const OrderForm = () => {
  ...
  const [harga, setHarga] = useState(
    selectedProduct ? selectedProduct.harga : 0
  );
  ...
  const handleJumlahChange = (event) => {
    ...
    if (isNaN(newJumlah)) {
      ...
      alert(
        `Jumlah yang dimasukkan melebihi stok yang tersedia [${selectedProduct.total}].`
      );
    }
  };
  ...
  const handleSubmit = (event) => {
    ...
    const whatsappURL = `https://wa.me/6281281939361?text=${encodeURIComponent(
      message
    )}`;
  ...
  return (
    <section className="bg-gray-100 text-gray-900 relative min-h-screen font-poppins">
      <Helmet>
        <title>Order Form - Gerai Wirausaha Mandiri</title>
        <meta
          name="description"
          content="Formulir pemesanan di Gerai Wirausaha Mandiri untuk produk yang dipilih. Isi formulir untuk melanjutkan pemesanan."
        />
      </Helmet>
      <Link to="/">
        <img
      ...
      <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x ">
        <div className="md:order-2 md:py-0 md:px-6 my-4">
          <form
            ...
            className="w-full space-y-6 md:mx-0 mx-8"
          >
            <h1 className="text-4xl font-bold pt-3 mr-6">
              Formulir Pesanan untuk{" "}
            ...
            <label className="block mr-8">
              <span className="mb-1">Metode Pembayaran:</span>
              <br />
              <input
                type="radio"
                id="transfer"
            ...
            <div className="flex justify-end pt-8">
              <button
                type="submit"
                className="self-center px-6 py-3 text-lg bg-button-gradient text-gray-600 md:mr-0 mr-6 hover:opacity-70 font-medium rounded-lg"
              >
                Kirim
              </button>
            </div>
        ...
        <div className="md:order-1 md:py-0 md:px-6 my-4 flex justify-center items-center mx-8 md:mx-0">
          <div className="py-6 md:py-0 md:px-6">
            ...
            <p className="pt-2 pb-4">
              Hubungi kontak berikut apabila anda ingin memesan atau memiliki
              pertanyaan mengenai produk:
            </p>
            <div className="space-y-4">
              <p className="flex items-center">
                <a
                  href="https://www.google.com/maps/place/Polsek+Lambaro+Angan/@5.5871243,95.3961925,17z/data=!3m1!4b1!4m6!3m5!1s0x304049d7291446bb:0x34dd837a82500540!8m2!3d5.5871243!4d95.3987674!16s%2Fg%2F11g65bzznz?entry=ttu"
                  target="_blank"
                  className="flex"
                  rel="noreferrer"
                >
                  ...
                  />
                  <p>
                    Depan Polsek Lambaro Angan, Lambada Peukan, Kec. Darussalam,
              ...
              <p className="flex items-center">
                <a
                  href="https://wa.me/6281281939361"
                  target="_blank"
                  className="flex"
                  rel="noreferrer"
                >
